...
export default function App() {
  ...
  const canSend = useMemo(() => {
    ...
    return Boolean(form.latitude && form.longitude && form.vs30 && form.floors && form.building_age)
  }, [form])
            ...
            {result ? (
              ...
              <div className="rounded-2xl border border-slate-200 bg-white/60 p-6 shadow-sm backdrop-blur dark:border-slate-800 dark:bg-slate-900/20">
                <div className="space-y-2">
                  ...
                  <div className="rounded-xl border border-slate-200 bg-white/60 p-4 text-xs text-slate-600 dark:border-slate-800 dark:bg-slate-950/30 dark:text-slate-300">
                    Location values are used alongside soil, building, and foundation features to estimate
                    damage risk.
                  </div>
                </div>
              </div>
